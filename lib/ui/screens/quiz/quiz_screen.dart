...
class QuizScreen extends StatefulWidget {
  ...
  final bool isPlayed; //Only in use when quiz type is  questions //! aud
...
class _QuizScreenState extends State<QuizScreen> with TickerProviderStateMixin {
  ...
  bool hasSubmittedAnswerForCurrentQuestion() {
    return context
        .read<QuestionsCubit>()
        .questions()[currentQuestionIndex] // ? the questions list
        .attempted;
  }
  ...
  Future<void> submitAnswer(String submittedAnswer) async {
    ...
    if (!context //*  check if question attempted
        .read<QuestionsCubit>()
      ...
      await Future<void>.delayed(
        const Duration(
            seconds:
                inBetweenQuestionTimeInSeconds,), //* wait to load the next question
      );
