                                        ...
                                        <form id="frmQuestion" method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input id="file" name="file" type="file" accept="image/*" class="form-control" style="height: 210px; width: 100%; font-size: 23px; padding: 10px;">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    <input type="submit" name="btnadd" value="<?= lang('submit'); ?>" class="<?= BUTTON_CLASS ?>"  style="font-size: 18px; padding: 15px 30px; height: 60px; width: 100%;"/>
                                                </div>
                                            </div>
