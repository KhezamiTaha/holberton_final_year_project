                                        ...
                                        <table aria-describedby="mydesc" class='table-striped' id='question_list' data-toggle="table" data-url="<?= base_url() . 'Table/question' ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-size="100" data-page-list="[5, 10, 20, 50, 100, 200, All]" data-search="true" data-toolbar="#toolbar" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-mobile-responsive="true" data-sort-name="id" data-sort-order="asc" data-pagination-successively-size="3" data-maintain-selected="true" data-show-export="true" data-export-types='["csv","excel","pdf"]' data-export-options='{ "fileName": "question-list-<?= date('d-m-y') ?>" }' data-query-params="queryParams">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col" data-field="subcategory" data-sortable="true" data-visible='true'><?= lang('sub_category'); ?></th>
                                                    <?php if (is_language_mode_enabled()) { ?>
                                                        <th scope="col" data-field="language_id" data-sortable="true" data-visible='false'><?= lang('language_id'); ?></th>
                                                        <th scope="col" data-field="language" data-sortable="true" data-visible='false'><?= lang('language'); ?></th>
                                                    <?php } ?>
                                                    <th scope="col" data-field="image" data-sortable="false"><?= lang('image'); ?></th>
                                                    <th scope="col" data-field="question" data-sortable="true" data-visible='false'><?= lang('question'); ?></th>
                                                    <th scope="col" data-field="question_type" data-sortable="true" data-visible='false'><?= lang('quesion_type'); ?></th>
                                                    <th scope="col" data-field="optiona" data-sortable="true" data-visible='false'><?= lang('option_a'); ?></th>
                                                    <th scope="col" data-field="optionb" data-sortable="true" data-visible='false'><?= lang('option_b'); ?></th>
                                                    <th scope="col" data-field="optionc" data-sortable="true" data-visible='false'><?= lang('option_c'); ?></th>
                                                    <th scope="col" data-field="optiond" data-sortable="true" data-visible='false'><?= lang('option_d'); ?></th>
                                                    ...
                                                    <th scope="col" data-field="note" data-sortable="true" data-visible='true'><?= lang('note'); ?></th>
